...
public class Producto {
    ...
    /**
     * Obtiene el idProducto correspondiente a la columna del mismo nombre
     * 
     * @return un entero correspondiente a idProducto de la tabla Productos 
     */
    ...
    /**
     * Establece el idProducto correspondiente a la columna del mismo nombre
     * 
     * @param idProducto Un entero correspondiente al idProducto
     */
    ...
    /**
     * Obtiene el valor de la columna precio como un BigDecimal
     * 
     * @return Un BigDecimal correspondiente a la columna correspondiente a precio
     */
     ...
     */
    public void setPrecio(BigDecimal precio) throws NumeroInvalidoException {
        if (precio == null) {
            throw new NumeroInvalidoException("El precio no puede ser null");
        }

        if (precio.compareTo(BigDecimal.ZERO) < 0) {
            throw new NumeroInvalidoException("El precio debe ser 0 o mayor");
        }

        if (precio.compareTo(new BigDecimal("9999999999.99")) > 0) {
            throw new NumeroInvalidoException(
                "El precio excede el máximo permitido: 9,999,999,999.99"
            );
        }
